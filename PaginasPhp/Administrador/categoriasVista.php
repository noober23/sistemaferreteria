             ...
             $table.="<th width='300'>Descripcion</th>";
              ...
              $table.="</thead>"; 
               ...
               while($fila = $resultado->fetch_assoc())
               {
               	...
               	$table.="<td><a class='btn icon-btn btn-success' href='javascript:editarCategoria(".$fila["idCategoria"].")'>Editar</a>";
               	$table.="   <a class='btn icon-btn btn-danger' href='javascript:eliminarCategoria(".$fila["idCategoria"].")'>Eliminar</a></td>";
               	 $table.="</tr>"; 
               	 $contador=$contador+1;
               }
               $resultado->free();
...
function altaCategoria(){
	$form = "<form id='alta-categoria' class='formulario' data-insertarCategoria>";
	$form .="<fieldset>";
	$form .=" <div>";
	...
	$form.="<input type='hidden' value='insertarCategoria' id='Transaccion' name='Transaccion' />";
	$form.="</div>";
	$form.="</fieldset>";
	$form.="</form>";
	return printf($form);
...
function cargarDatosCategoria($id){
	...
	$form = "<form id='editar-categoria' class='formulario' data-editarCategoria>";
	$form .="<fieldset>";
	$form .=" <div>";
	$form .=" <label form='descripcion'> Descripcion: </label>";
	...
	$form.="<input type='hidden' value='editarCategoria' id='Transaccion' name='Transaccion' />";
	$form.="<input type='hidden'  value='".$fila["idCategoria"]."' id='cod' name='cod' />";
	$form.="</div>";
	$form.="</fieldset>";
	$form.="</form>";
	$form.="<hr>";
