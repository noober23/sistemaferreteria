...
////////////////////
var listaClientes = document.querySelector("#listaClienteVendedor");
var listaProductos = document.querySelector("#listaProducto");
var buscarVentasVendedor = document.querySelector("#buscarVentaFechasVendedor");
var insertarVentasVendedor = document.querySelector("#insertarVentaVendedor");
 buscarProductos = document.querySelector("#buscarProducto");
...
function cargar()
{
	...
	buscarVentasVendedor.addEventListener("click",buscarVentasFecha);
	insertarVentasVendedor.addEventListener("click",ingresarVenta);
...
{
	var datos = "Transaccion=listarClientesVendedor";
...
{
	var datos = "Transaccion=listarProductosVendedor";
	evento.preventDefault();
	ejecutarAJAX(datos);
}
