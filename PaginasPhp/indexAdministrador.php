            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a><i class="fa fa-user fa-fw"></i> <?php  echo $usuario1." ".$tipo;?></a>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="indexAdministrador"><i class="fa fa-windows  fa-fw"></i> Inicio</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="javascript:cargar();" id="listaVentaAdministrador"><i class="fa fa-angle-right -o fa-fw"></i>Lista</a>
                                </li>
                                <li>
                                    <a href="javascript:cargar();" id="insertarVentaAdministrador"><i class="fa fa-angle-right -o fa-fw"></i>insertar</a>
                                </li>
                                  <li>
                                    <a href="javascript:cargar();" id="buscarVentaFechasAdministrador"><i class="fa fa-angle-right -o fa-fw"></i>Reporte de ventas por fecha</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
